...
public class PlayerService {
	...
	public void addItemToInventory(String playerId, Item item) {
		List<InventoryItem> inventory = playerInventories.computeIfAbsent(playerId, k -> new ArrayList<>());// 유저 인벤토리
																											// 초기화 또는
																											// 불러오기

		Optional<InventoryItem> existing = inventory.stream().filter(i -> i.getName().equals(item.getName()))
