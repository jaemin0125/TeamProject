...
//     ({ isWalking, isBackward, isJumping, isRight, isLeft, isIdle, isRunning, isSitted, isSittedAndWalk, isLyingDown, isLyingDownAndWalk, isPunching, isHitted, isDead, isAiming, position = [0, 0.9, 0], scale = [0.8, 0.8, 0.8] }, ref) => {
...
//             }
//         }, [isWalking, isBackward, isJumping, isRight, isLeft, isIdle, isRunning, isSitted, isSittedAndWalk, isLyingDown, isLyingDownAndWalk, isPunching, isHitted, isDead, isAiming, actions, mixer, clonedScene, animations, glbPath]);
